...
The Buda EDC is Buda's city-funded economic development corporation. It runs the [[wiki/concepts/buda-hive|Buda HIVE]] entrepreneurship incubator and is pursuing [[wiki/concepts/aedo|AEDO]] accreditation through the IEDC (only 90 orgs worldwide, 12 in Texas). Jennifer Storm was recognized as IEDC Economic Developer of the Year.

## Relationship to Moil

Buda EDC is a **paying B2G customer** — they purchase [[wiki/moil/positioning|Moil]] platform licenses for each [[wiki/concepts/buda-hive|Buda HIVE]] cohort participant. This is recurring per-cohort revenue.

Andres Urrego and [[wiki/people/joshua-edmond|Joshua Edmond]] serve as **Incubator Strategists** under contract — they design and deliver the HIVE curriculum together.

| Angle | Value |
|---|---|
| Revenue | Per-seat Moil licenses for cohorts |
| Credibility | City government customer + Jennifer's AEDO award |
| Expansion template | Replicable with other TX EDCs and chambers |
| Product distribution | Cohort grads become organic Moil users |
| Positioning | Andres as respected coach/expert in Buda ecosystem |
...
## SoSX Event (March 12, 2026)

**Event:** Buda HIVE SoSX — "Experience the Vibe of SXSW, Closer to Home"
**Location:** Meridian Buda (see [[wiki/orgs/meridian-buda]])
**Time:** 5:00 PM – 8:00 PM

**Run of Show:**
- 5:00–6:00 PM: Registration & Networking (drink tickets, HIVE stickers, entrepreneur tables)
- 6:00–6:10 PM: Jacquie Martinez & Casey Earley open — share HIVE vision, announce Cohort 4 (starts April 20)
- 6:10–6:15 PM: Jennifer Storm speaks — EDC impact, HIVE role, Economic Developer of the Year
- 6:15–6:25 PM: Jennifer introduces **Josh Edmond & Andres Urrego** as Incubator Strategists
- 6:25–6:40 PM: **Josh & Andres** at the mic — cohort testimonials from 4 graduates:
  - Anita Lansing, Jacob Campbell, Desiree Steele, Kerry Ann Pearce
- 6:40–6:55 PM: Casey reads Certificates of Completion — Cohorts 2 & 3 graduation
- 6:55–7:40 PM: **Pitch Competition** — Josh & Andres facilitate; judges announced; Grand Prize; Steve Acord (Waterloo Media) thanked as sponsor
- 7:45–7:50 PM: Winners announced + photos
- 7:50–8:00 PM: Jacquie wraps; Ian Stewart band at 8:30pm

**Significance:** This event established Andres as a named Incubator Strategist in the Buda EDC ecosystem — public credibility, pitch competition facilitator, community face.

## HIVE Program Structure

See [[wiki/concepts/hive-program]] for the full series-based curriculum (Hatch → Initiate → Validate → Expand).
