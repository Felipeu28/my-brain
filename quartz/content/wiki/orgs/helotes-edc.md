...
Helotes EDC (Economic Development Corporation, City of Helotes, TX) is an **active warm prospect** parallel to Buda EDC. Katherine ("Kate") Silvas is the CEO / primary contact. She is actively planning the Helotes incubator strategy with her Board and has explicitly asked to **include Moil as the offering provided to incubator clients** — a mirror of the Buda HIVE engagement model.

## Key Person

- **Katherine Silvas** — CEO, Helotes EDC — see [[wiki/people/katherine-silvas]]
...
| Date | Event |
|------|-------|
| Pre-2026-02-19 | Andres visits Helotes; in-person conversations with Katherine |
| 2026-02-19 | Andres sends "Helotes Visit Follow up" |
| 2026-02-26 | Katherine responds — "started using the app, got sidetracked, want to schedule follow-up" |
...
This is the **2nd EDC incubator partnership** after Buda EDC. Two incubators in Texas on the same model is a repeatable B2G channel:
- Per-cohort license revenue (like Buda EDC Cohort 4)
- Embedded Business Coach social capital
- Proof for expansion to other city EDCs (Queen Creek, Johns Creek, Claremont, etc.)
