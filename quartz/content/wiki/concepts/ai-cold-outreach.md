...
- **@adriannalakatos** — "The Cold Outreach Bible" (Apr 10)
- **@itsalexvacca** — "I Gave AI One URL and Asked It to Build a Cold Email Campaign From Scratch"
- **@dimitarangg** — "How I Abuse Claude to Write Emails That Book Fortune 500 Companies"
- **@levikmunneke** — "Claude Code + Google Maps = 7-figure outbound team" — uses Maps API to find local businesses and auto-generate personalized outreach
- **@DeRonin_** — "Claude + LinkedIn = 11 clients" — unlimited lead generation
