...
> **Organization principle:** Customers sorted by importance × recency. P1 = paying NOW. P2 = engaged/warm. P3 = historical.

---

## P1 — Currently Active (Paying in April 2026)
...
## P2 — Warm Prospects (Engaged, Not Yet Paying)
...
## P3 — Historical (Past Clients, No Current Engagement)
...
**Luis Vives — Business Owner, Texas:** 5/5 — "Easy and effective for posting positions and connecting with candidates."

**Liliana Cervantes — SMB Owner, Texas:** 5/5 — "Recommends for both job seeking and finding workers."

**Miguel Bustos — Service Business, Texas:** 5/5 — "Uses Moil to find employees when extra help needed."

## Candidate-Side Testimonials

- **Sierra Givhaan** — "Very straightforward and easy... saved so much time and money."
- **Carlos Zuluaga** — "The app will create a professional resume... I highly recommend."
- **Contreras Ed** — "Easy to navigate app... 10/10."
- **Christian Jose Torres** — "Helped me get a job in Bixby, Oklahoma."

## Product Demo Testimonials

- **Dafne Gutierrez** — Used resume builder with voice input in Feb 2025; strong positive reaction. See [[wiki/people/dafne-gutierrez]].
- **Rick Bough** (Hays CISD) — Tried resume builder live Mar 26, 2025; said he'd create his own resume that day. See [[wiki/people/rick-bough]].
- **Daniela Castillo Cañavera** — Used resume builder Dec 2024; loved it; considered equity partnership. See [[wiki/people/daniela-castillo-canavera]].

## Aggregate Platform Metrics

- 500+ businesses using Moil
- 50,000+ job seekers on candidate platform
- 5,000+ jobs posted monthly
- 25,000+ job placements
...
- No named Enterprise/Market Pro tier customers with documented case studies
- No before/after metrics for any active client (the HVAC example on website is hypothetical)
- Customer churn data not captured
- Group onboarding UX has known friction (TXOR April 2025 — login issues with 30+ at once)
