...
**Related:** [[moil/index]], [[andres/index]], [[moil/metrics]]
...
Moil operates as a **lean digital platform** with a remote or hybrid team model. Key principles from the operations reference:

- Hire against revenue milestones, not ahead of them
- Prioritize roles that protect product reliability, customer retention, and onboarding quality
- AI handles support at scale (24/7 coaching built into product); human CSM handles edge cases
- One CSM can support ~300 active users → at current ~500 active businesses, this is the next hiring trigger

---

## Hiring Triggers (from Business Plan)

| Trigger | Next Hire |
|---------|-----------|
| >500 active customers | Customer Success Manager |
| >$25K MRR | Marketing or growth hire |
| >1,200 active customers | Second software engineer |
| Product-market fit confirmed | Head of Sales (community-led → outbound hybrid) |

---

## Connections

- [[andres/index]] — Full Andres profile (background, operating principles, relationships)
- [[moil/metrics]] — Revenue and growth targets that drive headcount decisions
- [[moil/go-to-market]] — GTM motion that determines what roles to hire first
- [[concepts/buda-hive]] — EDC partner ecosystem
