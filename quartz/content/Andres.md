...
**Vault root:** `~/My Brain/knowledge-base/`

---

## How Claude navigates this wiki

Read this file first. Follow links to topic indexes. Do NOT scan every file — use the index chain.

1. Find the relevant section below
2. Open that section's index or folder
3. Read only the pages that are relevant
...
```
knowledge-base/
  raw/           ← Drop sources here (articles, transcripts, PDFs, notes)
  wiki/          ← Organized knowledge pages (auto-maintained by Claude Code)
    concepts/    ← Frameworks, mental models, industry terms
    meetings/    ← Structured notes from meetings and voice memos
    moil/        ← Positioning, ICP, GTM, campaigns, decisions
    people/      ← Key contacts, customers, investors, advisors
    inbox/       ← New notes added manually by Andres
  outputs/       ← Generated briefings, reports, drafts
  index.md       ← This file (master map)
  log.md         ← Ingestion history
  CLAUDE.md      ← Ingestion instructions for Claude Code
```
...
- [[wiki/orgs/buda-chamber]] — Greater Buda Chamber of Commerce, community partnership
...
| Date | Source | Type | Key Pages Created |
|------|--------|------|-------------------|
| 2026-04-11 | imessages-people-2026-04-09.md | relationship-intelligence | john-costilla, mark-polanco, travis-sutherland + family context |
| 2026-04-11 | outlook-emails-2026-04-09.md | email-digest | daniel-guadiano, shay-foley context |
| 2026-04-11 | buda-hive-edc-2026-04-11.md | partnership-intel | jennifer-storm, joshua-edmond, jacquie-martinez, buda-hive, aedo, campaignos |
| 2026-04-11 | moil-documents-2026-04-09.md | business-plan | positioning, icp, gtm (populated from plan data) |
| 2026-04-11 | moilapp-website-2026-04-09.md | company-website | positioning, icp, gtm (enriched with website copy) |
| 2026-04-11 | facebook-pages-2026-04-09.md | social-media | personal/business page stats for gtm channels |
| 2026-04-11 | github-project-tracker.md | project-tracker | context for AGENTS.md and task prioritization |
| 2026-04-11 | outlook-email-research-2026-04-11 | email-deep-dive | monica-davidson, rosemary-gamez, kim-dowers, buda-chamber, queen-creek-chamber, jennifer-storm (updated) |
