...
**Last updated:** 2026-05-12 (Weekly compile pass — automated priority-rot check. No demotions triggered: oldest 🔥 Immediate item is Apr 28 (exactly 14d, not *more than* 14d); 📅 Next 2–3 weeks window ends today; no Verify: items; ✅ Closed/Archive already empty. No new substantive raw sources to ingest since Run 45 this morning (email-digest-2026-05-11 + signal-brief-2026-05-11). Wiki freshness audit found **0 stale orphans** across 314 pages. **Link integrity:** all 78 wikilinks in index.md resolve. Run 44 header text below preserved for context.)
