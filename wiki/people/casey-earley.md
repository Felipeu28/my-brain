...
**Source:** [[raw/buda-hive-edc-2026-04-11]], [[raw/email-digest-2026-04-17]], [[raw/email-digest-2026-04-28]], [[raw/email-digest-2026-04-29]], [[raw/teams-transcript-heather-skeen-2026-04-30]], [[raw/email-digest-2026-05-05]], [[raw/email-digest-2026-05-14]]
...
## May 5 — Incubator Strategist Scope of Work accepted

Source: [[raw/email-digest-2026-05-05]]

Casey accepted the *"Incubator Strategist - Scope of Work"* calendar invite on May 5 (15:45 UTC). First Casey-side calendar accept on the **Incubator Strategist SoW** track — the contract surface that anchors Andres's role with Buda EDC beyond the per-cohort license. Pairs with the Mon May 4 in-person PSA review with Jacquie ([[wiki/meetings/2026-05-04-monday-collaboration]] context) — same week the SoW conversation moved from PSA artifacts to a calendar-locked Incubator Strategist work session. Watch for the meeting outcome; this is where Andres's annual EDC compensation/scope likely gets formalized.

## May 14, 2026 — Andres bio request fulfilled

Source: [[raw/email-digest-2026-05-14]]

Andres replied to Casey at 14:56 CDT on the *"Andres Urrego Bio"* thread — sent **bio options for Buda EDC use**. Implies Casey requested the bio for an upcoming EDC publication / event collateral / speaker page. **First on-record EDC-side request for an Andres-as-public-figure asset** — pair with the John Costilla *"Buda Business Leader / AI Convening"* + the May 13 Buda EDC magazine 2-page Moil + HIVE spread (MEMORY May 11 block) + the Jacquie 33-license expansion. Pattern: **Buda EDC is now actively packaging Andres as a public-facing figure** across multiple surfaces simultaneously.
...
- **2026-05-14** · `email-digest` · sent bio options for Buda EDC use
- **2026-05-12** · `teams` · Carolina to ask about EDC renovation grant for backyard buildout · also: email-digest
- **2026-05-11** · `email-digest` · recipient on outbound email
- **2026-05-05** · `email-digest` · accepted Incubator Strategist Scope of Work calendar invite
