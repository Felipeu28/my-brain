...
**Source:** [[raw/teams-transcript-carolina-2026-04-30]], [[raw/email-digest-2026-04-30]], [[raw/teams-transcript-carolina-andres-2026-05-12]], [[raw/email-digest-2026-05-12]], [[raw/signal-briefs/signal-brief-2026-05-12]]
...
**Email:** caro0@hotmail.com
**Nickname:** Caro
**Cohort:** Buda HIVE Cohort 4 (Apr 20 – Jun 8, 2026)
**Language:** Bilingual — coaching session conducted in Spanish
**Origin:** Mexico City. Moved to Buda Aug 2025. Age 46.

> Possible match for the legacy [[wiki/people/carol-hive-cohort|Carol]] (Cohort 3, Jan 29 2026 session) — left as separate pages until confirmed.

## Background

- **Graphic designer** by training; freelance web/logo work for income today
- **12 years** running a café in Mexico City (closed during COVID)
- Moved to **Mérida**, opened a **yoga studio** — personal/spiritual win, financial loss; sold the business
- **1,000-hour certified yoga instructor** (post-India spiritual path)
- **Online master's in holistic psychology**
- The Mérida yoga-studio failure left her hesitant to re-enter entrepreneurship — *"acabé muy desgastada y con un poco de miedo de volver al ruedo"*

## Why she's in HIVE Cohort 4

She and her husband own a house on **Austin Street directly behind [[wiki/orgs/meridian-buda|Meridian Buda]]**. They built out the backyard (privacy fence, cowboy pool, sauna inbound, outdoor furniture) intending to open a **holistic spa** — one year of effort and significant cost killed by City of Buda permitting. The house currently runs as **Airbnb**, hitting ~$2,500/mo target rent only intermittently (Jan–Feb were terrible).

## What she's building (post Apr 30 1:1)

**Pivot:** holistic spa → **women-focused coworking space** ("woman cave" / *"un mancave para mujeres"*). Coworking by day, occasional small events. Spa amenities (sauna, cold plunge, cowboy pool) become add-on perks, not the headline.

**Why this is the right wedge:**
- Buda already has a yoga studio (longstanding), a Meridian spa, and a physical-therapy practice with spinal alignment — adding more wellness would be undifferentiated
- Buda HIVE was originally meant to be a coworking space but couldn't fit — there's an unmet need
- Caro already owns the asset (house is sunk cost) — replaces Airbnb income, doesn't have to exceed it initially
- Cohort 4 already has 4 women + 15 total — built-in waitlist toward the 25-member breakeven

**Tagline she generated organically:** *"un mancave para mujeres."* Connected to her own moment — escapes to the Airbnb house when she can't get more than 40 uninterrupted minutes at home.

## Pricing model floated (Apr 30)

- Basic coworking: **$75–$100/mo**
- Mid tier with one event/month included: **~$250/mo** (vs. paying separately for venue + catering elsewhere)
- Annual prepay discount (e.g., $900/yr instead of $1,200) — captures upfront cash, survives slow months
- Husband's hard floor: replace the $2,500/mo Airbnb revenue. 25 × $100 OR 50 × $75 covers it

## Cross-references

- [[wiki/meetings/2026-04-30-carolina-coaching]] — full session notes
- [[wiki/concepts/buda-hive]] — incubator program
- [[wiki/orgs/buda-edc]] — funder
- [[wiki/orgs/meridian-buda]] — neighbor venue (house is directly behind it)
...
**Cross-source flag (signal-brief-2026-05-12):** Caro appeared across three source types in one day — teams (the coaching session), email-digest (11:00 CDT *"estoy llegando a la casa, me conecto en 5 minutos"* arrival ping), and as the live signup that triggered the in-call Buda EDC HIVE Moil-license precedent disclosure. Signal brief framed her as **the test case for whether EDCs will pay per-seat for cohort participants as a productized revenue line** — making her week-of EDC pitch to Jackie the load-bearing experiment.
...
- **17:09 UTC** — Andres forwarded the Teams meeting booking confirmation (*"FW: Carolina & Andres"*) to Caro
- **18:16 UTC** — Andres sent a Spanish follow-up: *"¡Me encantó tu idea, Caro! Próximos pasos."* Positive reinforcement of the women-coworking direction within ~5 hours of the session ending. Same-day post-coaching follow-through pattern (mirrors Heather)
...
- **2026-05-12** · `teams` · coaching on women coworking concept, reframed ICP, signed up for Moil · also: email-digest
<!-- AUTO-ACTIVITY:end -->
