...
**Repo(s):** [`Moil-Landingpages/fit-logic`](https://github.com/Moil-Landingpages/fit-logic)
**Primary contact:** [[wiki/people/megan-miller|Megan Miller, NP]] (owner) + [[wiki/people/michelle-fitlogic|Michelle]] (practice manager / day-to-day Moil 360 operator)
**Org page:** [[wiki/orgs/fitlogic]]

---

## Status

Anchor Moil 360 customer; first end-to-end delivery completed Apr 29 in an 88-min walkthrough with both Megan and Michelle. Post-delivery posture: P0 bug list open (pipeline-stage propagation, Content360 February-date default, edit-image regeneration constraint, Brand DNA color propagation). Hiring track active in parallel — first Moil-sourced hire imminent. Outstanding ask from Megan: switch payment plan from $500/mo × 3 to $250/mo × 6.
...
- Are the four P0 bugs blocking expansion to next client onboard, or are they background fixes?
- Does Moil 360 need a v2 release before the next end-to-end delivery?
- Payment plan ask ($500×3 → $250×6) — accept, counter, or hold?
