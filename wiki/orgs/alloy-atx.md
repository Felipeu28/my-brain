...
- **Website:** alloyatx.com
- **Business type:** Fitness / wellness (group fitness, self-defense, events)
- **Locations:** Lakeline, Round Rock, South Austin
- **Primary contact:** [[wiki/people/roxana-yglesias|Roxana Yglesias]] (r.yglesias@alloyatx.com)
- **Deal status:** ✅ CLOSED — Moil 360 Market Pro at $75/month (month-to-month)
- **Revenue model:** Monthly retainer

## Current Website

- **Structure:** Landing page → "How It Works" → "Programs" → "Real Stories" → "Contact Us"
- **SEO gaps:** No Q&A sections on any page; no Google Search Console; AEO (AI Engine Optimization) not addressed
- **Previous agency:** Gabriel (contractor) + Shannon (social media) — full handover in progress
- **Domains:** Roxana owns multiple domains on GoDaddy — planned for satellite SEO landing pages

## Moil Engagement Plan

1. Roxana completes 21 strategic questions → Moil generates market research
2. Market research drives website content rewrites (Q&A on every page for SEO + AEO)
3. 30-day content calendar from Moil 360 → post in local Facebook groups (educational, not spammy)
4. Events promoted 15 days ahead of month start; content file ready by 15th of each month
5. 2–3 satellite landing pages on Roxana's GoDaddy domains → all lead back to alloyatx.com
6. Spanish-language landing pages for Mexican fitness community connections
...
- [ ] Full asset handover from Shannon (social media) and Gabriel (contractor)
- [ ] Roxana completes 21 strategic questions
- [ ] Google Search Console setup
- [ ] SEO audit + Q&A recommendations per page
- [ ] Satellite landing page domain brainstorm (by Apr 17)
- [ ] Moil360 content delivery with Ablad (Abiodun Solomon)

## Connections

- [[wiki/people/roxana-yglesias]] — owner
- [[wiki/people/abiodun-solomon]] — Moil360 content delivery
- [[wiki/meetings/2026-04-14-roxana-alloy-atx-onboarding]] — full meeting record

## Moil Relevance

First fitness/wellness vertical client — proves Moil360 applies beyond service businesses. Self-defense events are a strong content angle. Roxana's wellness referral network (functional medicine, regenerative medicine contacts in Colombia) could generate additional Moil customers. Spanish-language landing page strategy is a new playbook that could scale to other bilingual clients.
