...
> **This page is the single source of truth for every active deal.** The morning briefing reads it. Updated by Claude during ingestion runs and manually by Andres.
...
| Deal | Contact | Product | Stage | Last Touch | Days Since | Next Action |
|------|---------|---------|-------|------------|------------|-------------|
...
| Partner | Contact | Model | Status | Last Touch | Next Action |
|---------|---------|-------|--------|------------|-------------|
| **Buda EDC / HIVE** | [[wiki/people/jennifer-storm]], [[wiki/people/jacquie-martinez]] | Per-cohort license (B2G) | ✅ Active — Cohort 4 starts Apr 20 | Apr 2 | Board approval Apr 15; prep materials |
| **TXOR** | [[wiki/people/evangeline-sandoval]], Zane Gibson | Workshop partner | ⚠️ Verify | Nov 2024 origin | Are recurring workshops still running? |
| **Queen Creek Chamber** | [[wiki/people/kim-dowers]] | Out-of-state EDC model | 🟡 Warm | Feb 2026 | Re-engage after Buda HIVE proves model |

## 🧊 Cold / Deferred

| Lead | Why Cold | Re-engage Date | Trigger |
|------|----------|---------------|---------|
| **Shay Foley / Johns Creek Chamber** | Budget year starts Jul 1 | Jul 2026 | Pitch AI tools using Buda EDC as case study |
| **Daniela Castillo / Univision** | Equity discussion stalled | Q3 2026 | Only if Moil raises or hits $25K MRR |
| **Rick Bough / Hays CISD** | CTE teacher PD invite Aug 2025 | Aug 2026 | Verify: did Aug 2025 PD happen? Re-pitch 2026 |
| **Tampa Bay (via Zachary Barker)** | Enterprise eval; not public | TBD | Verify via Josh Edmond; Zachary said May 2025 |

## Pipeline Summary

| Stage | Count | Est. Annual Value |
|-------|-------|-------------------|
...
1. **Morning briefing** reads this page and flags deals with no activity in 7+ days
2. **Teams ingestion** (daily 6pm) adds new deals mentioned in chat
3. **Email ingestion** surfaces new leads from inbox/sent
4. **Manual** — Andres updates stage and next actions after calls

Move closed deals to [[wiki/moil/customers]] after 30 days.
